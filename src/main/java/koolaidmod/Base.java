...
public class Base {
    ...
    public static final String MODID = "koolaidmod";
    public static final String MOD_NAME = "The Kool-Aid Mod";
    public static final String VERSION = "1.0-SNAPSHOT";

    public static final CreativeTabs MOD_TAB = new ModCreativeTabs();
